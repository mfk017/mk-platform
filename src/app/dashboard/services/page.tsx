...
export default function ServicesPage() {
  ...
  return (
    <>
      ...
      {/* Action Bar */}
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-surface-container-lowest p-4 rounded-xl border border-secondary/10 shadow-sm mb-6">
        ...
        <div className="flex items-center space-x-3 w-full sm:w-auto">
          ...
          <button 
            ...
            className="flex items-center justify-center space-x-2 px-4 py-2 bg-primary text-on-primary rounded-lg font-label-sm hover:bg-primary-container hover:text-on-primary-container transition-colors shadow-sm w-full sm:w-auto"
          >
      ...
      <div className="bg-surface-container-lowest rounded-xl border border-secondary/10 shadow-sm overflow-hidden">
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-outline-variant/20 font-ibm-plex-sans text-body-md text-on-surface">
              ...
              <tr className="hover:bg-surface-container-low transition-colors group">
                ...
                <td className="px-6 py-4">Boarding</td>
                <td className="px-6 py-4 text-right font-mono">
                  4,500<span className="text-on-surface-variant text-label-xs">/mo</span>
                </td>
                <td className="px-6 py-4">
              ...
              <tr className="hover:bg-surface-container-low transition-colors group">
                ...
                <td className="px-6 py-4">Training</td>
                <td className="px-6 py-4 text-right font-mono">
                  350<span className="text-on-surface-variant text-label-xs">/hr</span>
                </td>
                <td className="px-6 py-4">
                  <div className="flex flex-col items-center">
              ...
              <tr className="hover:bg-surface-container-low transition-colors group">
                ...
                <td className="px-6 py-4 text-right font-mono">
                  500<span className="text-on-surface-variant text-label-xs">/ride</span>
                </td>
                <td className="px-6 py-4">
                  <div className="flex flex-col items-center">
        ...
        <div className="px-6 py-4 border-t border-outline-variant/30 bg-surface flex items-center justify-between">
          ...
          <div className="flex space-x-2">
            <button className="px-3 py-1 border border-outline-variant rounded-md text-sm text-on-surface-variant hover:bg-surface-container-low disabled:opacity-50" disabled>
              Prev
            </button>
            <button className="px-3 py-1 border border-outline-variant rounded-md text-sm text-on-surface-variant hover:bg-surface-container-low">
              Next
            </button>
          </div>
        </div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          {/* Modal Content */}
          <div className="relative bg-surface-container-lowest rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden border border-secondary/10 z-10">
            {/* Modal Header */}
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <input className="w-full px-3 py-2 bg-surface rounded-lg border border-outline-variant/50 focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none transition-shadow" dir="rtl" placeholder="مثال: قفز الحواجز" type="text" />
                    </div>
                  </div>
                  <div className="space-y-1">
                    <label className="block text-label-sm text-on-surface">Category</label>
                    <select className="w-full px-3 py-2 bg-surface rounded-lg border border-outline-variant/50 focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none transition-shadow">
            ...
            <div className="px-6 py-4 border-t border-outline-variant/30 bg-surface flex justify-end space-x-3 shrink-0">
              ...
              <button className="px-6 py-2 bg-primary text-on-primary font-label-sm rounded-lg hover:bg-primary-container hover:text-on-primary-container transition-colors shadow-sm">
                Save Service
              </button>
            </div>
          </div>
